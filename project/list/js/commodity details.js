class List{
    constructor(){
        ...
        this.url = "http://localhost:8181/project/list/goods.json";
    ...
    addEvent(){
        ...
        this.main2.onclick = function(eve){
            ...
            if(t.className == "addCar"){
                that.id = t.parentNode.getAttribute("index");  //获取当前的商品ID
                console.log(that.id);
                that.setData();    //存localstorage
            }
        }
    }
    setData(){
    ...
    init(){
        ...
        ajaxGet(this.url,function(res){
            ...
            // }else{
            //     alert("请先登陆");
            //     window.location.href = "localhost:8181/login/login.html";
            // }
            that.display();
        })
    }
